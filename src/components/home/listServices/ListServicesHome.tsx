  ...
  return (
    ...
    >
      <ContainerMedium
        ...
        data-aos-offset="0"
      >
        <Title title={'Serviços'} subTitle={'nossas especialidades'} />
        <ul className="listServices">
          <li data-aos="flip-left">
            <SquareBoxLink
              href="/especialidades/consultoria-empresarial"
            ...
            >
              ...
              <p className="title-squareBoxLink">Consultoria Empresarial</p>
              <p className="resume-squareBoxLink">
                Fazemos a análise preventiva de legislação, contratos e negócios
                jurídicos, com sinergia com as demais áreas de atuação do
                escritório, visando evitar conflitos, minimizando riscos e
